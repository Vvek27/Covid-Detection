...
train_path= r"C:\Users\Hp\Documents\GitHub\Covid-Detection\Train"
...
validation_path=r"C:\Users\Hp\Documents\GitHub\Covid-Detection\Validation"
...
def Images():
    if st.checkbox("Covid Images"):
        folder_n=r"C:\Users\Hp\Documents\GitHub\Covid-Detection\Train\covid"
    ...
    if st.checkbox("Normal Images"):
        folder_n=r"C:\Users\Hp\Documents\GitHub\Covid-Detection\Train\normal"
        a=random.choice(os.listdir(folder_n))
        b=random.choice(os.listdir(folder_n))
        c=random.choice(os.listdir(folder_n))
        random_n=[a,b,c]
